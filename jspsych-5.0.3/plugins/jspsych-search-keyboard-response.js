...
jsPsych.plugins["html-search-keyboard-response"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-search-keyboard-response',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    graphics.beginPath();
    graphics.arc((95, 50, radius, 0, 2 * Math.PI);
    graphics.stroke;

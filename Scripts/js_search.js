...
// warn users before they try to leave the page if the experiment has not been completed
    ...
    var full_screen = {
        ...
        stimulus:'<center><br><br>Welcome to the experiment!<br><br>Please work on a <b>desktop or laptop</b> for this experiment.<br>',
        choices:' ',
 ...
 //trial3: display ending message
   var trial3 = {
       ...
       choices: [' '],
        ...
        trial.stimulus = '<p style="margin: 0; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">Experiment ended! You answered '+ circle_info[0] + ' circles and the final circle size you chose was '+ circle_info[1] +'<br><br> Please press the space bar to continue.</p>';},
       stimulus: ''
   };
...
//Demographics
    ...
    var inst4 = {
        type: 'html-keyboard-response',
        stimulus:'<p style="margin-left: 20%; margin-right: 20%; text-align:left;">You are about to complete this HIT. Please answer the next few questions very honestly.  Your answers won\'t affect your payment.',
        choices:' ',
        prompt: 'Please press "space" to continue.</center>'
    };
    ...
    tline.push(similar);
     ...
     jsPsych.init({
        ...
        on_finish: function (data) {
           ...
           $("body").append('<p style="margin: 0; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">The experiment is complete. Thank you very much for participating! Your code for M turk is LPCE'+randomCode+'.</p>');
            doNotClose = false;
         }
      });
